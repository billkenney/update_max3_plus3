...
the portion before #1 is for those who use the imsge from @CChen616. you can skip this section if youre using my image. both have minor issues, so its really up to you
...
in order to get this image working, you have to run the following commands (this fixes the issues towards the bottom of his readme):<br>
